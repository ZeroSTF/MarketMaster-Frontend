...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,OverviewdetailsComponent,NewsComponent,TradesoverviewComponent,ChartComponent,CoursComponent,QuickMatchComponent,CurrentGamesComponent,LiveEventsComponent,YourGamesComponent],
